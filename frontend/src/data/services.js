...
Recovery from wisdom teeth removal is typically quick, especially for younger patients. Don't let wisdom teeth problems affect your quality of life.`,
    ...
    seo: {
      title: 'Wisdom Teeth Removal Melbourne | Expert Oral Surgeon',
      description: 'Professional wisdom teeth removal in Moorabbin, Melbourne. Dr Bala provides expert surgical extraction with minimal discomfort. Call (03) 9555 5960.'
    }
  },
  {
    id: 'dental-implants',
...
Dr Bala works closely with your dentist to ensure the best possible outcome.`,
    ...
    seo: {
      title: 'Dental Implants Melbourne | Tooth Replacement Surgery',
      description: 'Expert dental implant placement in Moorabbin by Dr Bala. Permanent tooth replacement that looks and functions naturally. Book a consultation today.'
    }
  },
  {
    id: 'all-on-four',
...
Our surgeons will carefully assess your situation and recommend the best approach. You can choose between general anesthesia or local anesthesia for your comfort.`,
    ...
    seo: {
      title: 'Tooth Extraction Melbourne | Oral Surgeon',
      description: 'Professional tooth extractions in Moorabbin. Dr Bala provides safe, comfortable removal of damaged teeth. Call (03) 9555 5960.'
    }
  },
  {
    id: 'bone-grafting',
...
Moorabbin Oral Surgery offers various bone grafting techniques tailored to each patient's specific needs.`,
      ...
      types: [
        ...
        'Ridge augmentation - rebuilds width or height of jawbone',
        'Sinus lift - adds bone below the sinus for upper implants',
        'Block bone grafts - for larger defects'
      ],
    ...
    seo: {
      title: 'Bone Grafting Melbourne | Jawbone Reconstruction',
      description: 'Expert bone grafting for dental implants in Moorabbin. Dr Bala provides jawbone reconstruction surgery. Book a consultation.'
    }
  },
  {
    id: 'impacted-teeth',
...
Over several months, the orthodontist applies gentle pressure to guide the tooth into its correct position. Our team of experienced surgeons and orthodontists work together to create a personalised treatment plan.`,
    ...
    seo: {
      title: 'Impacted Teeth Surgery Melbourne | Orthodontic Exposure',
      description: 'Surgical exposure of impacted teeth for orthodontic treatment in Moorabbin. Dr Bala works with orthodontists for optimal results.'
    }
  },
  {
    id: 'oral-pathology',
...
If you notice any unusual changes in your mouth, don't delay — schedule a consultation for a thorough examination. We may recommend a biopsy to determine the cause and develop a personalised treatment plan.`,
    ...
    seo: {
      ...
      description: 'Expert diagnosis and treatment of oral pathology in Moorabbin. Dr Bala provides comprehensive assessment of oral diseases and lesions.'
    }
  },
  {
    id: 'tmj-treatment',
...
Dr Bala provides comprehensive evaluation of TMJ problems and develops individualised treatment plans.`,
      ...
      treatment: `Treatment is tailored to each patient and may include:
...
- Surgery (in severe cases)`
    ...
    seo: {
      title: 'TMJ Treatment Melbourne | Jaw Pain Specialist',
      description: 'Expert TMJ disorder treatment in Moorabbin. Dr Bala provides comprehensive evaluation and management of jaw pain and dysfunction.'
    }
  },
  {
    id: 'trauma-surgery',
...
Emergency appointments are available for acute trauma cases.`,
      ...
      treatment: `Treatment depends on the type and severity of injury. This may include:

- Reimplantation of knocked-out teeth
- Splinting of loosened teeth
- Surgical repair of jaw fractures
- Soft tissue repair and suturing
- Reconstructive surgery

Time is critical with dental trauma. If a tooth is knocked out, keep it moist and seek care immediately.`,

      emergency: `For dental emergencies during office hours, call (03) 9555 5960. We will make every effort to see you as soon as possible.`
    },
    seo: {
      title: 'Dental Trauma Surgery Melbourne | Emergency Oral Surgeon',
      description: 'Emergency treatment for facial trauma and dental injuries in Moorabbin. Dr Bala provides prompt expert care. Call (03) 9555 5960.'
    }
  }
]
